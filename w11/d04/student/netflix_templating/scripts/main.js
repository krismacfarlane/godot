...
$(document).ready(function(){
  ...
  // grabs the template source as a string
  var userTemplateSource = $("#user-template").html();

  // generates new function and saves it to a variable
  var generateUserHTML = _.template(userTemplateSource);
  var userHTML = generateUserHTML({ imgHREF: "https://pbs.twimg.com/profile_images/378800000532546226/dbe5f0727b69487016ffd67a6689e75a.jpeg", firstName: "CAT!"});
